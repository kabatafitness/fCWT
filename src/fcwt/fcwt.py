...
class Gaus(Wavelet):
    ...
    def __init__(self, bandwidth, degree):
        _fcwt.Gaus_swiginit(self, _fcwt.new_Gaus(bandwidth, degree))

    def generate(self, *args):
        return _fcwt.Gaus_generate(self, *args)

    def getSupport(self, scale):
        return _fcwt.Gaus_getSupport(self, scale)
...
# Register Gaus in _fcwt:
_fcwt.Gaus_swigregister(Gaus)
